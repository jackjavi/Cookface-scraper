// import phrases from "./gainPhrases.js";
import commentsSpecial from './commentsSpecial';
import {Page} from 'puppeteer';

async function retweetOwnPostAndCommentSpecial(
  label: string,
  page: Page,
  randomPhrase: string,
) {
  ...
  function getRandomWaitTime(min: number, max: number) {
        ...
        try {
          ...
          if (retweetButton) {
            ...
            if (ariaLabel) {
              ...
              await commentsSpecial(article, page);
...
export default retweetOwnPostAndCommentSpecial;
